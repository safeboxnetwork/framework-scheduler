...
<p align="justify"> - <b>framework-scheduler</b>: it responsibles for the core functionality of the platform using linux kernel based builtin application, the Inotify to discover and response for any changes  </p>
